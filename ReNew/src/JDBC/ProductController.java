...
public class ProductController {
	/*
	 * 상품등록, 상품리스트 보기, 상품 상세보기, 상품 수정, 상품 삭제 Controller <-> Service <-> DAO <-> DB
	...
	private void remove() {
		// 상품 번호를 받아서 해당 상품을 삭제 
		System.out.println("삭제상품번호>");
	...
	private void register() {
		...
		// isOk insert 후 리턴되는 값을 저장 잘되는 1이 리턴, 안되면 0이 리턴
