...
public class 자료형변환 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 자동 자료형 변환 : 자료형 변환시 생략해도 문제가 되는 않는 상황
		...
		num1= (int)num2; //num1=num2; error(double이 더 크기 때문) int=double (명시적 형변환)
	 ...
	 * */
		...
		double kor= 70.8; double eng=47.5; double math= 68;
		System.out.println(kor+eng+math);// 186.3 
		System.out.println((kor+eng+math)/3); //62.1
